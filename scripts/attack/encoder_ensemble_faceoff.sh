export EXPERIMENT_NAME="Encoder_attack_test"
...
# for person_id in "5"; do   
    ...
    python3 attacks/encoder_ensemble_faceoff.py \
        ...
        --pgd_alpha=5e-3 \
        --pgd_eps=0.06274509803921569
        
done 


export EXPERIMENT_NAME="Encoder_attack_conda-photomaker_24-255"
export device="cuda:3"
...
# for person_id in "5"; do   
    ...
    python3 attacks/encoder_ensemble_faceoff.py \
        ...
        --max_adv_train_steps=6 \
        --pgd_alpha=5e-3 \
        --pgd_eps=0.18823529411764706
        
done 


export EXPERIMENT_NAME="Encoder_attack_conda-photomaker_32-255"
export device="cuda:3"

...
def initialize_folder():
    home = '/home/humw/Codes/FaceOff/evaluations/'
...
def extract_faces(
    ...
    if len(face_objs) == 0 and enforce_detection is False:
        face_objs = [(img, img_region, 0, None, None, None)]

    for current_img, current_region, confidence, landmarks, angle, direction in face_objs:
        if current_img.shape[0] > 0 and current_img.shape[1] > 0:
            ...
            extracted_face = [img_pixels, region_obj, confidence, landmarks, angle, direction]

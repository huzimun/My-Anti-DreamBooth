export adversarial_folder_name="custom-diffusion_Encoder_attack_conda-photomaker_VGGFace2_vae15-ipadapter-photomaker_mix_eot-0_yingbu_agm-2_norm-0_SD15"
...
cp "./scripts/eval/eval_custom-diffusion_new_FaceOff.sh" $save_config_dir
...
export adversarial_folder_name="custom-diffusion_VGGFace2_SD15"
echo $adversarial_folder_name
export device="cuda:2"
export adversarial_input_dir="./outputs/adversarial_images/${adversarial_folder_name}"
export customization_output_dir="./outputs/customization_outputs/${adversarial_folder_name}"

export EXPERIMENT_NAME="CAAT_SD15_test2_anti-dreambooth_seed-1"
...
export EXPERIMENT_NAME="TED_conda-photomaker_test2_vae15-ipadapter-photomaker_mix_eot-0_yingbu_agm-2_norm-0"
export DATASET_DIR="./outputs/adversarial_images/${EXPERIMENT_NAME}"
...
export EXPERIMENT_NAME="IDProtector_conda-photomaker_test2_vae15-ipadapter-photomaker_cosine_eot-0_non-target_agm-2_norm-0"
export DATASET_DIR="./outputs/adversarial_images/${EXPERIMENT_NAME}"

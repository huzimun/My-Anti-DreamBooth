...
export distance_choice="cosine" # mse or cosine, mix use mse for vae, and cosine for ipadapter and photomaker
...
# use AGM
export agm=3 # 1使用AGM，0取平均，2手动调整10:1:1，3手动调整5：1：1
if [ "$agm" = 1 ]; then

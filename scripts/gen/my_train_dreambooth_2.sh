export EXPERIMENT_NAME="Encoder_attack_conda-photomaker_VGGFace2_vae15-ipadapter-photomaker_mix_eot-0_yingbu_agm-2_norm-0_jpeg75"
...
export EXPERIMENT_NAME="Encoder_attack_conda-photomaker_VGGFace2_vae15-ipadapter-photomaker_mix_eot-0_yingbu_agm-2_norm-0_jpeg50"
export DATASET_DIR="./outputs/adversarial_images/"$EXPERIMENT_NAME
...
export EXPERIMENT_NAME="Encoder_attack_conda-photomaker_VGGFace2_vae15-ipadapter-photomaker_mix_eot-0_yingbu_agm-2_norm-0_jpeg25"
export DATASET_DIR="./outputs/adversarial_images/"$EXPERIMENT_NAME
